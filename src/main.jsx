 ...
 return <div className="app">
   ...
   <main className="grid">
    ...
    <section className="content">
      ...
      {isAdmin&&<div className="addTable panel"><input placeholder="Nome da nova mesa" value={newTable.name} onChange={e=>setNewTable({name:e.target.value})}/><button onClick={addTable}><Plus size={15}/> Adicionar mesa</button></div>}
